...
<body>
	<div class="my_serach">
		...
		<select class="btn btn-default dropdown-toggle" id="my_status" name="process_status">
			<option  value="2">全部</option>
   			<option  value="0" selected="selected">待染色</option>
   			<option value="1">已染色</option>
   		</select>
	...
	<script type="text/html" id="barDemo">
		{{#  if(d.process_status_name ==='已前处理'){ }}
		<a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="assign">染色</a>
		{{#  } }}
	</script>
	<script>
	...
	layui.use('table', function(){
		 ...
		 var tableIns = table.render({
		    ...
		    ,cols: [[ 
	          ...
	          ,{field: 'dye_date', title:'染色日期', width:130, align:'center'}
	          ,{field: 'dye_person', title:'染色人', width:130, align:'center'}
			  ...
			  if(layEvent === 'assign'){
				  layer.open({
					  ...
					  ,area:['600px', '700px']
				  	  ...
				  	  ,maxmin:true
				  	  ,anim:1
				  	  ,content:['toRanse.do?process_id='+data.process_id]
				  	  ,btn:['确认', '取消']
				  	  ,btnAlign: 'c'
				  	  ,yes:function(index, layero){
						var	nums = layer.getChildFrame('#dye_num', index);
