...
<body>
	<div class="my_serach">
		...
		<select class="btn btn-default dropdown-toggle" id="my_status" name="process_status">
			<option  value="2">全部</option>
   			<option  value="0" selected="selected">待印花</option>
   			<option value="1">已印花</option>
   		</select>
	...
	<script type="text/html" id="barDemo">
		{{#  if(d.process_status_name ==='已前处理' || d.process_status_name ==='已染色'){ }}
		<a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="assign">印花</a>
		{{#  } }}
	</script>
	<script>
	...
	layui.use('table', function(){
		 ...
		 var tableIns = table.render({
		    ...
		    ,cols: [[ 
	          ...
	          ,{field: 'print_date', title:'印花日期', width:130, align:'center'}
	          ,{field: 'print_person', title:'印花人', width:130, align:'center'}
			  ...
			  if(layEvent === 'assign'){
				  layer.open({
					  ...
					  ,area:['600px', '700px']
				  	  ...
				  	  ,maxmin:true
				  	  ,anim:1
				  	  ,content:['toPrintdye.do?process_id='+data.process_id]
				  	  ,btn:['确认', '取消']
				  	  ,btnAlign: 'c'
				  	  ,yes:function(index, layero){
						var	nums = layer.getChildFrame('#print_num', index);
