		...
		<div class="col-md-12 column">
			...
			<table class="table" id="my_table">
				<tr>
					...
					<td>
						<input name="ro_id" type="text" maxlength="8" id="role_id">
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<input name="ro_name" type="text" maxlength="10" id="role_name">
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<textarea name="ro_remark" rows="3" class="form-control"></textarea>
					</td>
				</tr>
			</table>
		</form>
...
<!-- <script type="text/javascript">
	function myfunction() {
		var emp_id = document.getElementById('role_id').value;
