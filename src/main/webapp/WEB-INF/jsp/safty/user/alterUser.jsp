		...
		<div class="col-md-12 column">
			...
			<table class="table" id="my_table">
				<tr>
					...
					<td>
						<input name="u_id" type="text" maxlength="8" id="user_id" value="${CheckUser.u_id}" readonly="readonly">
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<input name="u_name" type="text" maxlength="10" value="${CheckUser.u_name}" id="user_name">
					</td>
				</tr>
			</table>
		</form>
