		...
		<div class="col-md-12 column">
			...
			<table class="table" id="my_table">
				<tr>
					...
					<td>
						<input name="standard_id" value="${standard_id}" readonly="readonly" id="pro_standard_id">
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<input name="standard_name" type="text" maxlength="10" id="pro_standard_name">
					</td>
				</tr>
			</table>
		</form>
