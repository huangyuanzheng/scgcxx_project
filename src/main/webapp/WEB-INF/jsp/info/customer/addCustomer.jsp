		...
		<div class="col-md-12 column">
			...
			<table class="table" id="my_table">
				<tr>
					...
					<td>
						<input name="cus_id" value="${customer_id}" id="customer_id" readonly="readonly">
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<input name="cus_name" type="text" maxlength="10" id="customer_name">
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<textarea name="cus_remark" rows="3" class="form-control"></textarea>
					</td>
				</tr>
			</table>
		</form>
